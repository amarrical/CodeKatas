...
class TestStringCalculator < Minitest::Test
  [['empty_string', ''],
   ['nil', nil]
    ...
    define_method("test_add_return_zero_when_supplied_#{name_and_number[0]}") do
      assert_equal(0, Calculator.add(name_and_number[1]))
    end
  end
  ...
  ].each do | name_numbers_and_expected |
    define_method("test_add_return_number_when_supplied_#{name_numbers_and_expected[0]}") do
  ...
  [['one_two_three', '1,2,3', 6],
   ...
   ['two_newlines', "1\n2\n3,4,5", 15]
    ...
    define_method("test_and_return_sum_when_supplied_#{name_numbers_and_expected[0]}") do
     assert_equal(name_numbers_and_expected[2], Calculator.add(name_numbers_and_expected[1]))
   end
  end
  ...
  [['zero_two', '0,2', 2],
   ...
   ['zero_three_two', '0,3,2', 5]
     ...
     define_method("test_add_return_sum_when_supplied_multiple_numbers_#{name_numbers_and_expected[1]}") do
       assert_equal(name_numbers_and_expected[2], Calculator.add(name_numbers_and_expected[1]))
     end
   end
  ...
  [['zero_three_1001', '0,3,1001', 3],
   ['zero_three_1000', '0,3,1000', 3]
    ...
    define_method("test_add_return_sum_by_ignore_more_than_thousand_#{name_numbers_and_expected[0]}") do
       assert_equal(name_numbers_and_expected[2], Calculator.add(name_numbers_and_expected[1]))
    end
  end
